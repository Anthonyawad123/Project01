...
<?php include("layouts/header.php"); ?>
            ...
            <div class="row container mx-auto">
              ...
              <h3 class="font-weight-bold">Account info</h3>
                ...
                <div class="account-info">
                  ...
                  <p><a href="account.php?logout=1" id="login-btn">logout</a></p>
                </div>
            </div>
  ...
  <form id="account-form" method="POST" action="account.php">
    ...
    <br>
    <div class="form-group">
      <input type="submit" id="change-password-btn" name="change-password" value="Change Password" class="btn btn-outline-primary">
    </div>
  </form>
</div>
      ...
      <td>
        ...
        <td>
          <form method="POST" action="order_details.php">
            ...
            <input type="submit" name="order_details_btn"class="btn btn-light" value="details">
          </form>
        </td>
    </tr>
    </tbody> 
